...
const CreatePostPage = () => {
  return (
    <form className="h-[90%] overflow-auto md:px-16 px-8 py-6 flex flex-col mx-auto my-9 items-center gap-6 w-fit rounded-lg bg-[#FFFFFF] shadow-xl dark:text-white dark:bg-[#141624]" >
