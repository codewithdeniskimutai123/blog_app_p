...
const Footer = () => {
  return (
    ...
    <footer className="bg-[#f6f6f7e9] px-4 py-16 container dark:bg-[#141624] ">
<div className="flex flex-wrap justify-between max-lg:gap-9 lg:gap-4 max-md:justify-center">
        <div className="w-[300px] flex flex-col gap-6 max-md:items-center ">
            <h1 className="text-[#141624] text-2xl dark:text-[#FFFFFF] ">
                DevScribe
            </h1>

            <p className="text-[14px] text-[#696A75] leading-normal  max-md:text-center dark:text-[#97989F]">DevScribe is a user-friendly Content Management System (CMS) that
            allows easy content creation and management. Built with React.js,
            Tailwind CSS, and Django, it offers features like user
            authentication and customizable light/dark themes.</p>
        </div>
        ...
        <div className=" text-[#181A2A] text-[14px] flex gap-4 flex-col px-4 max-md:items-center">
        ...
        <div className="bg-white w-[350px] px-6 flex flex-col items-center justify-center gap-2 rounded-lg dark:bg-[#242535] py-6">
            ...
            <div className="w-full relative">
                <input placeholder="Your Email" className="border border-[#DCDDDF] rounded-lg h-[40px] px-3 py-3 w-full text-[14px] dark:bg-[#181A2A] "/>

                <CiMail className="absolute top-[13px] right-[10px]  text-[16px] dark:text-[#97989F]"/>
            </div>

            <button className="bg-[#4B6BFB] text-[#FFFFFF] text-[16px] rounded-lg w-full py-3">
                Subscribe
            </button>
        </div>
